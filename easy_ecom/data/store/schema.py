...
TABLE_SCHEMAS: dict[str, list[str]] = {
    ...
    "users.csv": ["user_id", "client_id", "name", "email", "password_hash", "is_active", "created_at"],
    ...
    "inventory_txn.csv": ["txn_id", "client_id", "timestamp", "txn_type", "product_id", "qty", "unit_cost", "total_cost", "supplier_snapshot", "note", "source_type", "source_id", "lot_id"],
    ...
    "ledger.csv": ["entry_id", "client_id", "timestamp", "entry_type", "category", "amount", "source_type", "source_id", "note"],
