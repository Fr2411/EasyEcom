...
TABLE_SCHEMAS: dict[str, list[str]] = {
    ...
    "users.csv": ["user_id", "client_id", "name", "email", "password", "password_hash", "is_active", "created_at"],
    "roles.csv": ["role_code", "role_name", "description"],
    "user_roles.csv": ["user_id", "role_code"],
    "products.csv": ["product_id", "client_id", "supplier", "product_name", "category", "prd_description", "prd_features_json", "created_at", "is_active", "is_parent", "sizes_csv", "colors_csv", "others_csv", "parent_product_id"],
    "product_variants.csv": ["variant_id", "client_id", "parent_product_id", "variant_name", "size", "color", "other", "sku_code", "barcode", "default_purchase_price", "default_selling_price", "max_discount_pct", "is_active", "created_at"],
    ...
    "inventory_txn.csv": ["txn_id", "client_id", "timestamp", "user_id", "txn_type", "product_id", "variant_id", "product_name", "qty", "unit_cost", "total_cost", "supplier_snapshot", "note", "source_type", "source_id", "source_line_id", "lot_id"],
