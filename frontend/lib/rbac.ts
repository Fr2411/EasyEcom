const ROLE_PAGE_ACCESS: Record<string, string[]> = {
  ...
  CLIENT_OWNER: ['Home', 'Dashboard', 'Catalog', 'Inventory', 'Purchases', 'Sales', 'Customers', 'Finance', 'Returns', 'Reports', 'Settings'],
  CLIENT_STAFF: ['Home', 'Dashboard', 'Catalog', 'Inventory', 'Purchases', 'Sales', 'Customers', 'Returns', 'Settings'],
