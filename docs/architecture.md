...
- Customer Communication provides a tenant-safe AI assistant foundation for channel conversations, playbooks, backend-prepared live facts, model-composed replies, and draft-order handoff
