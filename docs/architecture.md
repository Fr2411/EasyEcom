...
- EasyEcom is also the orchestration layer for LLM flow. It calls the configured AI model API with tenant-scoped context and never exposes direct database access to the model.
