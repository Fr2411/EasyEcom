...
- EasyEcom orchestrates customer conversations inside the backend using the configured AI model API key. Catalog, stock, customer, and order actions must stay inside EasyEcom tenant-scoped services.
